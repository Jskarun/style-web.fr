...
class Draft extends DataMapper {
	...
	function default_templates($templates_indexed, $routes)
	{
		...
		{
			if (!isset($info['source']) && isset($templates_indexed[$info['template']]['source']))
			{
			...
			else if (isset($info['source']) && in_array($info['source'], array('tags', 'categories', 'albums', 'contents', 'essays', 'archives')) && !$default_links[$info['source']])
			{
