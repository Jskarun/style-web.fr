...
<img $params {$size}data-respond-to="{$options['respond_to']}" data-presets="<?php echo \$__presets; ?>" data-base="<?php echo \$__item['cache_path']['prefix']; ?>" data-extension="<?php echo \$__item['cache_path']['extension']; ?>"/>
DOC;
			}
			else
			{
