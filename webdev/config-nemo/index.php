...
// ****** Complément **********************************************************************************************************************************
	...
	$rech_conf = "SELECT * FROM configs WHERE valid=1 ORDER BY prix ASC";
	...
	while($tab_conf = mysql_fetch_array($exe_conf)){?>
		...
		<td><span class="bloc-config">
				...
				<img class="photo" src="img/home/<?php echo $tab_conf[photo];?>" border="0" alt="Accéder à la configuration <?php echo $tab_conf[nom];?>" />
				</a><br/>
